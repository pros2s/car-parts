          ...
          <div className='row'>
            ...
            >
              <div className='col-lg-12'>
                <div className='product-item hover-img'>
                  <a className='product-img'>
                    <img src={`${process.env.PUBLIC_URL}/images/b-img-2.jpg`} alt='' />
                  </a>
              ...
              <div className='col-lg-12'>
                <div className='product-item hover-img'>
                  <a className='product-img'>
                    <img src={`${process.env.PUBLIC_URL}/images/b-img-1.jpg`} alt='' />
                  </a>
                  <div className='product-caption'>
                    <h4 className='product-name'>
                      <a>
              ...
              <div className='col-lg-12'>
                <div className='product-item hover-img'>
                  <a className='product-img'>
                    <img src={`${process.env.PUBLIC_URL}/images/b-img-10.jpg`} alt='' />
                  </a>
                  <div className='product-caption'>
                    <h4 className='product-name'>
                      <a>
              ...
              <div className='col-lg-12'>
                <div className='product-item hover-img'>
                  <a className='product-img'>
                    <img src={`${process.env.PUBLIC_URL}/images/b-img-4.jpg`} alt='' />
                  </a>
                  <div className='product-caption'>
                    <h4 className='product-name'>
                      <a>
              ...
              <div className='col-lg-12'>
                <div className='product-item hover-img'>
                  <a className='product-img'>
                    <img src={`${process.env.PUBLIC_URL}/images/b-img-11.jpg`} alt='' />
                  </a>
                  <div className='product-caption'>
                    <h4 className='product-name'>
                      <a>
