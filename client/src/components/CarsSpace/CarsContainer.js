    ...
    if (fetchedCars.length === 0 && (buttonSearchClicked || homefilterActivated)) {
      ...
      return (
        <CarsList
          ...
          carslist={cars.slice((activePage - 1) * pageSize, (activePage - 1) * pageSize + pageSize)}
        />
      );
    }
  }
          ...
          <div className='col-sm-5 col-md-4 col-lg-3'>
            <div className='search-option m-b-lg-50 p-lg-20'>
              <div className='select-wrapper m-b-lg-15'>
                <div className='dropdown'>
                  ...
                  <ul className='dropdown-menu' aria-labelledby='dropdownMenu1'>
                    <li id='' onClick={this.setCarCondition}>
                      Any State
                    </li>
                    <li id='new' onClick={this.setCarCondition}>
                      New Cars
                    </li>
                    <li id='used' onClick={this.setCarCondition}>
                      Used Cars
                    </li>
                  </ul>
                </div>
              ...
              <div className='select-wrapper m-b-lg-15'>
                <div className='dropdown'>
                  <button
                    ...
                    aria-expanded='true'
                  >
                    {filters !== undefined && body !== undefined && body !== ''
                      ? body.toUpperCase()
                      : 'Body'}
                  </button>
                  <ul className='dropdown-menu' aria-labelledby='dropdownMenu2'>
                    <li id='' onClick={this.setCarBody}>
                      Any Body
                    </li>
                    <li id='sedan' onClick={this.setCarBody}>
                      Sedan
                    </li>
                    <li id='suv' onClick={this.setCarBody}>
                      SUV
                    </li>
                    <li id='truck' onClick={this.setCarBody}>
                      Truck
                    </li>
                    <li id='coupe' onClick={this.setCarBody}>
                      Coupe
                    </li>
                    <li id='minivan' onClick={this.setCarBody}>
                      Minivan
                    </li>
                    <li id='compact' onClick={this.setCarBody}>
                      Compact
                    </li>
                  </ul>
                </div>
              ...
              <div className='select-wrapper m-b-lg-15'>
                <div className='dropdown'>
                  ...
                  <ul className='dropdown-menu' aria-labelledby='dropdownMenu3'>
                    <li id='' onClick={this.setCarMake}>
                      Any Car Make
                    </li>
                    <li id='ford' onClick={this.setCarMake}>
                      Ford
                    </li>
                    <li id='huyndai' onClick={this.setCarMake}>
                      Huyndai
                    </li>
                    <li id='nissan' onClick={this.setCarMake}>
                      Nissan
                    </li>
                    <li id='chevrolet' onClick={this.setCarMake}>
                      Chevrolet
                    </li>
                    <li id='kia' onClick={this.setCarMake}>
                      Kia
                    </li>
                    <li id='mazda' onClick={this.setCarMake}>
                      Mazda
                    </li>
                    <li id='bmw' onClick={this.setCarMake}>
                      BMW
                    </li>
                    <li id='toyota' onClick={this.setCarMake}>
                      Toyota
                    </li>
                    <li id='mercedes' onClick={this.setCarMake}>
                      Mercedes Benz
                    </li>
                    <li id='ford' onClick={this.setCarMake}>
                      FOrd
              ...
              <div className='select-wrapper m-b-lg-15'>
                <div className='dropdown'>
                  <button
                    ...
                    aria-expanded='true'
                  >
                    {filters !== undefined && year !== undefined && year !== ''
                      ? year.toUpperCase()
                      : 'Year'}
                  </button>
                  <ul className='dropdown-menu' aria-labelledby='dropdownMenu5'>
                    <li id='' onClick={this.setCarYear}>
                      Any Year
                    </li>
                    <li id='2016' onClick={this.setCarYear}>
                      2016
                    </li>
                    <li id='2015' onClick={this.setCarYear}>
                      2015
                    </li>
                    <li id='2014' onClick={this.setCarYear}>
                      2014
                    </li>
                    <li id='2013' onClick={this.setCarYear}>
                      2013
                    </li>
                    <li id='2012' onClick={this.setCarYear}>
                      2012
                    </li>
                  </ul>
                </div>
              ...
              <div className='select-wrapper m-b-lg-15'>
                <div className='dropdown'>
                  <button
                    ...
                    aria-expanded='true'
                  >
                    {filters !== undefined && transition !== undefined && transition !== ''
                      ? transition.toUpperCase()
                      : 'Tranmission'}
                  </button>
                  <ul className='dropdown-menu' aria-labelledby='dropdownMenu6'>
                    <li id='' onClick={this.setCarTransition}>
                      Any Type
                    </li>
                    <li id='automatic' onClick={this.setCarTransition}>
                      Automatic
                    </li>
                    <li id='manual' onClick={this.setCarTransition}>
                      Manual
                    </li>
                    <li id='semi_automatic' onClick={this.setCarTransition}>
                      Semi-automatic
                    </li>
                  </ul>
                </div>
              ...
              <input
                ...
                type='text'
                disabled
                className='slider_amount m-t-lg-10'
                value={
              ...
              <button
                type='button'
                className='ht-btn ht-btn-default m-t-lg-30'
            ...
            <div className='banner-item banner-bg-4 banner-1x color-inher'>
              ...
              <h3 className='f-weight-300'>
                <strong>Interior</strong> Accessories
              </h3>
                    ...
                    <div className='select-wrapper'>
                      ...
                      <div className='dropdown pull-left'>
                        ...
                        <ul className='dropdown-menu' aria-labelledby='dropdownMenu2'>
                          ...
                          <li>
                            <a onClick={() => this.setPageSize(cars.length)}>All</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <ul className='pagination ht-pagination'>
                  <li>
                    <a
                      aria-label='Previous'
                      style={
                        this.state.activePage === 1 || cars.length !== 0
                          ? { display: 'none' }
                          : { display: 'block' }
                      }
                    >
                  ...
                  {table.map((i) => {
                    if (table.length <= 1) return '';
                      ...
                      return (
                        <li key={i} className={this.state.activePage === i ? 'active' : ''}>
                          <a
                            onClick={() => {
                  ...
                  <li>
                    <a
                      aria-label='Next'
                      style={
                        this.state.activePage === Math.ceil(cars.length / this.state.pageSize) ||
                        cars.length !== 0
                          ? { display: 'none' }
                          : { display: 'block' }
                      }
