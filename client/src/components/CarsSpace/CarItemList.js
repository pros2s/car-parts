        ...
        <div className='row'>
          ...
          <ul className='absolute-caption'>
            ...
            >
              <i
                ...
                className={this.state.isInWhishList ? 'fa fa-heart' : 'fa fa-heart-o'}
                style={heartStyle}
          ...
          <div className='col-sm-12 col-md-7 col-lg-7'>
            <div className='product-caption'>
              ...
              <p className='product-txt m-t-lg-10'>
                Nunc facilisis sagittis ullamcorper. Proin lectulputate
              </p>
...
export default connect(mapStateToProps, { fetchSingleCar, addToWhishList, removeFromWhishList })(
  CarItemList
);
