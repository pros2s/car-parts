        ...
        <div className='row m-lg-0'>
          <div className='col-xs-4 col-sm-4 col-md-4 col-lg-4 p-l-lg-0'>
            <a className='product-img'>
              <img
                src={`${process.env.PUBLIC_URL}/images/${this.props.item.product.imageName}`}
                alt=''
              />
            </a>
          </div>
          ...
          <div
            className='col-xs-1 col-sm-1 col-md-1 col-lg-1 p-lg-0'
            onClick={() => this.props.removeFromBasket(this.props.item.product._id)}
          >
